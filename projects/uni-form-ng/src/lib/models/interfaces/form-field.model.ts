...
export interface UniFormField extends Partial<UniInputText>, Partial<UniInputNumber>, Partial<UniSelectField>, Partial<UniSliderField>, Partial<UniSwitchField>, Partial<UniCheckboxField>, Partial<UniRadioField> {
